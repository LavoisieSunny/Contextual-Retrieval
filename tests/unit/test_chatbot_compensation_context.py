...
from app.main import chat_with_pdf, PDFChatRequest
...
class TestChatbotCompensationContext(unittest.TestCase):
    def test_chatbot_context_wording_and_values(self):
        ...
        with patch("app.services.chatbot.llm_client.generate_response") as mock_generate, \
             patch("app.services.qdrant.vector_db.semantic_search_rag") as mock_rag:
