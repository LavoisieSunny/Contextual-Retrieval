...
from app.services.document.parser_heuristics import (
    clean_legal_name,
    fuzzy_match_heading,
...
class TestParserHeuristics(unittest.TestCase):
    ...
    @unittest.skipIf(
        not os.path.exists(os.path.join(os.path.dirname(__file__), "ma3078_raw_text.txt")),
        "ma3078_raw_text.txt not found"
    )
