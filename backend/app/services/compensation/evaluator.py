import logging
from app.services.qdrant.vector_db import semantic_search
from app.services.compensation.calculator import CompensationRequest, calculate_death_compensation, calculate_injury_compensation
